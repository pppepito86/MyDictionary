...
//               myLocation.add(tmpY);
    ...
    static double[] MyTrilateration(double Lat1, double Long1, double distance1,
                            double Lat2, double Long2, double distance2,
                            double Lat3, double Long3, double distance3) {
...
//               dist3 = calDistToDeg(calFeetToMeter(51));
    ...
    public static double[] MyTrilateration2(AP ap1, double distance1,
                                     AP ap2, double distance2,
                                     AP ap3, double distance3) {
...
//               dist3 = calDistToDeg(calFeetToMeter(51));
        ...
        tmpLat2        = ap2.getX()-ap1.getX();
        tmpLong2       = ap2.getY() - ap1.getX();
        tmpLat3        = ap3.getX()-ap1.getX();
        tmpLong3       = ap3.getY() - ap1.getY();
        ...
        MyLocation[0] = MyLocation[0] + ap1.getY();
        MyLocation[1] = MyLocation[1] + ap1.getY();
